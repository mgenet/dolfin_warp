...
The library has notably used in:
...
```
conda create -n dolfin_warp
conda activate dolfin_warp
conda install -c conda-forge fenics=2019.1.0 gnuplot=5.4.3 mpi4py=3.1.3 pip python=3.10 vtk=9.0
conda env config vars set CPATH=$CONDA_PREFIX/include/vtk-9.0
conda activate dolfin_warp
